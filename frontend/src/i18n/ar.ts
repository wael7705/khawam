export const ar = {
  ...
  hero: {
    ...
    title: 'اطبع هويتك باحتراف — من الفكرة إلى التسليم خلال أيام',
    desc: 'تصميم، طباعة، وتسليم سريع بجودة مضمونة — أكثر من 500 عميل وثقوا بنا',
    cta: 'ابدأ طلبك الآن',
    howItWorks: 'شاهد أعمالنا',
  },
  services_icons: {
  ...
  myOrders: {
    title: 'تتبع طلبك',
    subtitle: 'تابع مسار طلبك خطوة بخطوة — تحديثات فورية وحالة واضحة بتجربة سينمائية',
    ...
    whatsappQuick: 'تواصل سريع',
    openMap: 'فتح الخريطة',
    reorder: 'إعادة الطلب',
    trackJourney: 'مسار الطلب',
  ...
  dashboard: {
    ...
    ordersPage: {
      ...
      cancelReasonTitle: 'إلغاء الطلب',
      cancelReasonLabel: 'سبب الإلغاء',
      cancelReasonPlaceholder: 'اذكر سبب إلغاء الطلب (مطلوب)...',
      cancelReasonRequired: 'سبب الإلغاء مطلوب (3 أحرف على الأقل)',
      confirmCancel: 'تأكيد الإلغاء',
      cancelFailed: 'فشل إلغاء الطلب',
      downloadAllFiles: 'تنزيل جميع الملفات',
      downloadingFiles: 'جاري التنزيل...',
