export const en = {
  ...
  myOrders: {
    ...
    subtitle: 'Follow your order journey step by step — live updates with a cinematic experience',
    ...
    whatsappQuick: 'Quick chat',
    openMap: 'Open map',
    reorder: 'Reorder',
    trackJourney: 'Order journey',
  ...
  dashboard: {
    ...
    ordersPage: {
      ...
      cancelReasonPlaceholder: 'Enter why this order is cancelled (required)...',
      cancelReasonRequired: 'Cancellation reason is required (at least 3 characters)',
