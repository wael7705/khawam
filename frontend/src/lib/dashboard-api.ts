...
const LEGACY_MOCK_SERVICES: ManagedService[] = [
  ...
  },
  {
    id: 'svc-dtf',
    name_ar: 'طباعة DTF',
    name_en: 'DTF Printing',
    description_ar: 'طباعة ديجيتال نقل حراري DTF.',
    is_active: true,
    is_visible: true,
    display_order: 13,
    features: {
      group_key: 'printing',
      group_label_ar: 'خدمات الطباعة',
      subgroup_key: 'digital-dtf',
      subgroup_label_ar: 'طباعة رقمية',
      subgroup_label_en: 'Digital printing',
    },
  },
  {
    id: 'svc-uv',
    name_ar: 'طباعة UV',
    name_en: 'UV Printing',
    description_ar: 'طباعة UV على مواد بسماكة محددة.',
    is_active: true,
    is_visible: true,
    display_order: 14,
    features: {
